...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('engiapp_committee', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comittee_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('engiapp', ['Committee'])

        # Adding model 'EngiEvents'
        db.create_table('engiapp_engievents', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('engiapp', ['EngiEvents'])

        # Adding model 'Student'
        db.create_table('engiapp_student', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('engiapp', ['Student'])

        # Adding M2M table for field events on 'Student'
        m2m_table_name = db.shorten_name('engiapp_student_events')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student', models.ForeignKey(orm['engiapp.student'], null=False)),
            ('engievents', models.ForeignKey(orm['engiapp.engievents'], null=False))
        ))
        db.create_unique(m2m_table_name, ['student_id', 'engievents_id'])

        # Adding model 'Team'
        db.create_table('engiapp_team', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('engiapp', ['Team'])

        # Adding M2M table for field members on 'Team'
        m2m_table_name = db.shorten_name('engiapp_team_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm['engiapp.team'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('engiapp_committee')

        # Deleting model 'EngiEvents'
        db.delete_table('engiapp_engievents')

        # Deleting model 'Student'
        db.delete_table('engiapp_student')

        # Removing M2M table for field events on 'Student'
        db.delete_table(db.shorten_name('engiapp_student_events'))

        # Deleting model 'Team'
        db.delete_table('engiapp_team')

        # Removing M2M table for field members on 'Team'
        db.delete_table(db.shorten_name('engiapp_team_members'))
    ...
    models = {
        ...
        'engiapp.engievents': {
            ...
            'committee': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['engiapp.Committee']"}),
        ...
        'engiapp.student': {
            ...
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['engiapp.EngiEvents']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'engiapp.team': {
            ...
            'team_leader': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['engiapp.Student']"}),

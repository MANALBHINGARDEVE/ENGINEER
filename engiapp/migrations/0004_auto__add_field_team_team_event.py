...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.team_event'
        db.add_column(u'engiapp_team', 'team_event',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['engiapp.EngiEvents'], unique=True),
                      keep_default=False)

        # Removing M2M table for field team_events on 'Team'
        db.delete_table(db.shorten_name(u'engiapp_team_team_events'))


    def backwards(self, orm):
        # Deleting field 'Team.team_event'
        db.delete_column(u'engiapp_team', 'team_event_id')
